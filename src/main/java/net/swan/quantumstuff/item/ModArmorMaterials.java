...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> QUANTUM_ARMOR_MATERIAL = register("quantum", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 30, 12f, 0.3f, () -> ModItems.QUANTUMINGOT.get());
